...
public:
    ...
    BallDecorator(const BallDecorator &other)
        : Ball(other), m_subBall(other.m_subBall->clone())
    {}

    /**
     * @brief clone - return a deep copy of this object
     */
    BallDecorator * clone () const override
    {
...
public:
    ...
    CueBall(const CueBall &other)
        : BallDecorator(other.m_subBall->clone()), MouseEventable(this)
    {}

    /**
     * @brief clone - return a deep copy of this object
     */
    CueBall * clone () const override
    {
...
public:
    ...
    BallSparkleDecorator(const BallSparkleDecorator &other)
        : BallDecorator(other.m_subBall->clone())
    {}

    /**
     * @brief clone - return a deep copy of this object
     */
    BallSparkleDecorator * clone () const override
    {
...
public:
    ...
    BallSmashDecorator(const BallSmashDecorator &other)
        : BallDecorator(other.m_subBall->clone())
    {}
     ...
     * @brief clone - return a deep copy of this object
     */
    BallSmashDecorator * clone () const override
    {
