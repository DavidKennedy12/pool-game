...
public:
    ...
    Ball(const Ball &other)
        : m_brush(other.m_brush), m_pos(other.m_pos ), m_velocity(other.m_velocity),
...
public:
    ...
    //copy constructor
    StageOneBall(const StageOneBall &other)
        : Ball(other)
    {}
     ...
     * @brief clone - return a deep copy of this object
     */
    StageOneBall * clone () const override
    {
...
public:
    ...
    CompositeBall(const CompositeBall &other)
        : Ball(other), m_strength(other.m_strength)
    {}

    /**
     * @brief clone - return a deep copy of this object
     */
    CompositeBall * clone () const override
    {
        CompositeBall *temp =  new CompositeBall(*this);
        for (auto it = this->m_children.begin(); it != this->m_children.end(); ++it)
        {
            Ball* ballA = *it;
            temp->addChild(ballA->clone());
        }
        return temp;
    }
